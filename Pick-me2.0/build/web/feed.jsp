    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            if(count==10) {
                ...
                alert("Error: Invalid number."+count);
                return false;
            }*/
            }
        </script>
        ...
        <div class ="container-fluid">
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="active"><a href="feed.jsp">Feedback<span class="sr-only">(current)</span></a></li>
              ...
              <div class="row">
                  <div class="col-lg-9 green">
                      <table>
                          <form action="feeddone.jsp"  onsubmit="return formvalid()">
                              <tr>
                                  <td>
                                      <b>Name: </b>
                                  </td>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <input type="text" name="feedb" value="" />
                                  </td>
                              </tr>
                              <tr>
           ...
           <img src="images/Bagheera.jpg" alt="Bagheera" class="storyOf">
           <p>
