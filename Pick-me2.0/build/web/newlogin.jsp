                  ...
                  <div class="col-lg-9 green">
                    ...
                    <div>
                        ...
                        <form name="myform" id="myform" method="get" action="newlogindb.jsp" onsubmit="return formvalid()">
                            ...
                            <td><input type="text" name="user" required="" value="" />
                            </td>
                            </tr>
                            <tr>
                            <td>
                            ...
                            <td>
                            <input type="password" name="pass2" id="pass2" required="" value="" />
                            </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" style="text-align: center">
                        <a href="index.html"> <input type="submit" class="btn btn-default" value="Cancel"></a>
                        </td>
                        </tr>
                        </table>
                    </div></center>
