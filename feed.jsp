    ...
    <body>
       ...
       <form action="feeddone.jsp">
           ...
           <b>Name: </b><input type="text" name="name" value="" />
            ...
            <div class="sidebar">
                <B>The Story of Bagheera</B>
                <br><br>
                <img src="images/Bagheera.jpg" width="300" height="300" alt="baghs"/>
                <br><br>
